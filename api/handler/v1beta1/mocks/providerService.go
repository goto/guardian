...
func (_m *ProviderService) CreateResource(_a0 context.Context, _a1 *domain.Resource) error {
	ret := _m.Called(_a0, _a1)
...
// ProviderService_CreateResource_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateResource'
type ProviderService_CreateResource_Call struct {
	*mock.Call
}
...
//   - _a0 context.Context
//   - _a1 *domain.Resource
func (_e *ProviderService_Expecter) CreateResource(_a0 interface{}, _a1 interface{}) *ProviderService_CreateResource_Call {
	return &ProviderService_CreateResource_Call{Call: _e.mock.On("CreateResource", _a0, _a1)}
}

func (_c *ProviderService_CreateResource_Call) Run(run func(_a0 context.Context, _a1 *domain.Resource)) *ProviderService_CreateResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProviderService_CreateResource_Call) Return(_a0 error) *ProviderService_CreateResource_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ProviderService_CreateResource_Call) RunAndReturn(run func(context.Context, *domain.Resource) error) *ProviderService_CreateResource_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *ProviderService_Expecter) Find(_a0 interface{}, _a1 interface{}) *ProviderService_Find_Call {
	return &ProviderService_Find_Call{Call: _e.mock.On("Find", _a0, _a1)}
}

func (_c *ProviderService_Find_Call) Run(run func(_a0 context.Context, _a1 domain.ListProvidersFilter)) *ProviderService_Find_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProviderService_Find_Call) RunAndReturn(run func(context.Context, domain.ListProvidersFilter) ([]*domain.Provider, error)) *ProviderService_Find_Call {
	_c.Call.Return(run)
	return _c
}
...
// PatchResource provides a mock function with given fields: _a0, _a1
func (_m *ProviderService) PatchResource(_a0 context.Context, _a1 *domain.Resource) error {
	ret := _m.Called(_a0, _a1)
...
// ProviderService_PatchResource_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PatchResource'
type ProviderService_PatchResource_Call struct {
	*mock.Call
}
...
//   - _a0 context.Context
//   - _a1 *domain.Resource
func (_e *ProviderService_Expecter) PatchResource(_a0 interface{}, _a1 interface{}) *ProviderService_PatchResource_Call {
	return &ProviderService_PatchResource_Call{Call: _e.mock.On("PatchResource", _a0, _a1)}
}

func (_c *ProviderService_PatchResource_Call) Run(run func(_a0 context.Context, _a1 *domain.Resource)) *ProviderService_PatchResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*domain.Resource))
	})
	return _c
...
func (_c *ProviderService_PatchResource_Call) Return(_a0 error) *ProviderService_PatchResource_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ProviderService_PatchResource_Call) RunAndReturn(run func(context.Context, *domain.Resource) error) *ProviderService_PatchResource_Call {
	_c.Call.Return(run)
	return _c
}
