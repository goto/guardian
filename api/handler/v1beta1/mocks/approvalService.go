...
// GenerateApprovalSummary provides a mock function with given fields: _a0, _a1, _a2
...
// ApprovalService_GenerateApprovalSummary_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GenerateApprovalSummary'
type ApprovalService_GenerateApprovalSummary_Call struct {
	*mock.Call
}
...
//   - _a2 []string
func (_e *ApprovalService_Expecter) GenerateApprovalSummary(_a0 interface{}, _a1 interface{}, _a2 interface{}) *ApprovalService_GenerateApprovalSummary_Call {
	return &ApprovalService_GenerateApprovalSummary_Call{Call: _e.mock.On("GenerateApprovalSummary", _a0, _a1, _a2)}
}

func (_c *ApprovalService_GenerateApprovalSummary_Call) Run(run func(_a0 context.Context, _a1 *domain.ListApprovalsFilter, _a2 []string)) *ApprovalService_GenerateApprovalSummary_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ApprovalService_GenerateApprovalSummary_Call) Return(_a0 *domain.SummaryResult, _a1 error) *ApprovalService_GenerateApprovalSummary_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ApprovalService_GenerateApprovalSummary_Call) RunAndReturn(run func(context.Context, *domain.ListApprovalsFilter, []string) (*domain.SummaryResult, error)) *ApprovalService_GenerateApprovalSummary_Call {
	_c.Call.Return(run)
	return _c
}
