...
func (_c *ActivityService_Import_Call) RunAndReturn(run func(context.Context, domain.ImportActivitiesFilter) ([]*domain.Activity, error)) *ActivityService_Import_Call {
	_c.Call.Return(run)
	return _c
}

type mockConstructorTestingTNewActivityService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewActivityService(t mockConstructorTestingTNewActivityService) *ActivityService {
