...
func (s *GRPCServer) ListGrants(ctx context.Context, req *guardianv1beta1.ListGrantsRequest) (*guardianv1beta1.ListGrantsResponse, error) {
	...
	filter := domain.ListGrantsFilter{
		...
		ResourceUrnStartsWith:           req.GetResourceUrnStartsWith(),
		ResourceUrnEndsWith:             req.GetResourceUrnEndsWith(),
		ResourceUrnContains:             req.GetResourceUrnContains(),
		ResourceUrnNotStartsWith:        req.GetResourceUrnNotStartsWith(),
		ResourceUrnNotEndsWith:          req.GetResourceUrnNotEndsWith(),
		ResourceUrnNotContains:          req.GetResourceUrnNotContains(),
