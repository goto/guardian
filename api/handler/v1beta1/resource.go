...
func (s *GRPCServer) ListResources(ctx context.Context, req *guardianv1beta1.ListResourcesRequest) (*guardianv1beta1.ListResourcesResponse, error) {
	...
	filter := domain.ListResourcesFilter{
		...
		ResourceUrnStartsWith:    req.GetUrnStartsWith(),
		ResourceUrnEndsWith:      req.GetUrnEndsWith(),
		ResourceUrnContains:      req.GetUrnContains(),
		ResourceUrnNotStartsWith: req.GetUrnNotStartsWith(),
		ResourceUrnNotEndsWith:   req.GetUrnNotEndsWith(),
		ResourceUrnNotContains:   req.GetUrnNotContains(),
