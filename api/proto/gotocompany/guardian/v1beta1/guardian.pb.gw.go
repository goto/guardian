...
func request_GuardianService_GenerateUserApprovalsSummaries_0(ctx context.Context, marshaler runtime.Marshaler, client GuardianServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GenerateUserApprovalsSummariesRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GenerateUserApprovalsSummaries(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_GuardianService_GenerateUserApprovalsSummaries_0(ctx context.Context, marshaler runtime.Marshaler, server GuardianServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GenerateUserApprovalsSummariesRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GenerateUserApprovalsSummaries(ctx, &protoReq)
	return msg, metadata, err

}

func request_GuardianService_GenerateApprovalsSummaries_0(ctx context.Context, marshaler runtime.Marshaler, client GuardianServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GenerateApprovalsSummariesRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GenerateApprovalsSummaries(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_GuardianService_GenerateApprovalsSummaries_0(ctx context.Context, marshaler runtime.Marshaler, server GuardianServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GenerateApprovalsSummariesRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GenerateApprovalsSummaries(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterGuardianServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GuardianServiceServer) error {
	...
	mux.Handle("POST", pattern_GuardianService_GenerateUserApprovalsSummaries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/gotocompany.guardian.v1beta1.GuardianService/GenerateUserApprovalsSummaries", runtime.WithHTTPPathPattern("/v1beta1/me/approvals/summaries"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_GuardianService_GenerateUserApprovalsSummaries_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_GuardianService_GenerateUserApprovalsSummaries_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_GuardianService_GenerateApprovalsSummaries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/gotocompany.guardian.v1beta1.GuardianService/GenerateApprovalsSummaries", runtime.WithHTTPPathPattern("/v1beta1/approvals/summaries"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_GuardianService_GenerateApprovalsSummaries_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_GuardianService_GenerateApprovalsSummaries_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGuardianServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GuardianServiceClient) error {
	...
	mux.Handle("POST", pattern_GuardianService_GenerateUserApprovalsSummaries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/gotocompany.guardian.v1beta1.GuardianService/GenerateUserApprovalsSummaries", runtime.WithHTTPPathPattern("/v1beta1/me/approvals/summaries"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_GuardianService_GenerateUserApprovalsSummaries_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_GuardianService_GenerateApprovalsSummaries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/gotocompany.guardian.v1beta1.GuardianService/GenerateApprovalsSummaries", runtime.WithHTTPPathPattern("/v1beta1/approvals/summaries"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_GuardianService_GenerateApprovalsSummaries_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_GuardianService_GenerateUserApprovalsSummaries_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1beta1", "me", "approvals", "summaries"}, ""))

	pattern_GuardianService_GenerateApprovalsSummaries_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1beta1", "approvals", "summaries"}, ""))
...
var (
	...
	forward_GuardianService_GenerateUserApprovalsSummaries_0 = runtime.ForwardResponseMessage

	forward_GuardianService_GenerateApprovalsSummaries_0 = runtime.ForwardResponseMessage
