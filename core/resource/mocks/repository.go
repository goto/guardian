...
func (_m *Repository) Create(_a0 context.Context, _a1 *domain.Resource) error {
	ret := _m.Called(_a0, _a1)
...
func (_c *Repository_Create_Call) Run(run func(_a0 context.Context, _a1 *domain.Resource)) *Repository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*domain.Resource))
	})
	return _c
...
func (_c *Repository_Create_Call) RunAndReturn(run func(context.Context, *domain.Resource) error) *Repository_Create_Call {
	_c.Call.Return(run)
	return _c
}
