...
func (_m *Repository) GenerateSummary(_a0 context.Context, _a1 domain.ListApprovalsFilter) (*domain.SummaryResult, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *Repository_GenerateSummary_Call) Run(run func(_a0 context.Context, _a1 domain.ListApprovalsFilter)) *Repository_GenerateSummary_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Repository_GenerateSummary_Call) RunAndReturn(run func(context.Context, domain.ListApprovalsFilter) (*domain.SummaryResult, error)) *Repository_GenerateSummary_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *Repository_Expecter) GetApprovalsTotalCount(_a0 interface{}, _a1 interface{}) *Repository_GetApprovalsTotalCount_Call {
	return &Repository_GetApprovalsTotalCount_Call{Call: _e.mock.On("GetApprovalsTotalCount", _a0, _a1)}
}
