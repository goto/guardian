...
// LabelingService is an autogenerated mock type for the labelingService type
...
// ApplyLabels provides a mock function with given fields: ctx, _a1, resource, policy
func (_m *LabelingService) ApplyLabels(ctx context.Context, _a1 *domain.Appeal, resource *domain.Resource, policy *domain.Policy) (map[string]*domain.LabelMetadata, error) {
	ret := _m.Called(ctx, _a1, resource, policy)
...
func (_e *LabelingService_Expecter) ApplyLabels(ctx interface{}, _a1 interface{}, resource interface{}, policy interface{}) *LabelingService_ApplyLabels_Call {
	return &LabelingService_ApplyLabels_Call{Call: _e.mock.On("ApplyLabels", ctx, _a1, resource, policy)}
}

func (_c *LabelingService_ApplyLabels_Call) Run(run func(ctx context.Context, _a1 *domain.Appeal, resource *domain.Resource, policy *domain.Policy)) *LabelingService_ApplyLabels_Call {
...
// MergeLabels provides a mock function with given fields: policyLabels, userLabels, allowOverride
func (_m *LabelingService) MergeLabels(policyLabels map[string]*domain.LabelMetadata, userLabels map[string]*domain.LabelMetadata, allowOverride bool) map[string]*domain.LabelMetadata {
	ret := _m.Called(policyLabels, userLabels, allowOverride)
	...
	if rf, ok := ret.Get(0).(func(map[string]*domain.LabelMetadata, map[string]*domain.LabelMetadata, bool) map[string]*domain.LabelMetadata); ok {
		r0 = rf(policyLabels, userLabels, allowOverride)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]*domain.LabelMetadata)
		}
...
//   - allowOverride bool
func (_e *LabelingService_Expecter) MergeLabels(policyLabels interface{}, userLabels interface{}, allowOverride interface{}) *LabelingService_MergeLabels_Call {
	return &LabelingService_MergeLabels_Call{Call: _e.mock.On("MergeLabels", policyLabels, userLabels, allowOverride)}
}

func (_c *LabelingService_MergeLabels_Call) Run(run func(policyLabels map[string]*domain.LabelMetadata, userLabels map[string]*domain.LabelMetadata, allowOverride bool)) *LabelingService_MergeLabels_Call {
	_c.Call.Run(func(args mock.Arguments) {
