...
func (_m *IamManager) GetClient(_a0 domain.SensitiveConfig) (domain.IAMClient, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(domain.SensitiveConfig) (domain.IAMClient, error)); ok {
		return rf(_a0)
	}
...
func (_m *IamManager) ParseConfig(_a0 *domain.IAMConfig) (domain.SensitiveConfig, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*domain.IAMConfig) (domain.SensitiveConfig, error)); ok {
		return rf(_a0)
	}
...
type mockConstructorTestingTNewIamManager interface {
	mock.TestingT
	Cleanup(func())
}

// NewIamManager creates a new instance of IamManager. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewIamManager(t mockConstructorTestingTNewIamManager) *IamManager {
	mock := &IamManager{}
	mock.Mock.Test(t)
