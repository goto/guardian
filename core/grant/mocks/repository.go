...
func (_m *Repository) Patch(_a0 context.Context, _a1 domain.GrantUpdate) error {
	ret := _m.Called(_a0, _a1)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.GrantUpdate) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *Repository_Expecter) Patch(_a0 interface{}, _a1 interface{}) *Repository_Patch_Call {
	return &Repository_Patch_Call{Call: _e.mock.On("Patch", _a0, _a1)}
}

func (_c *Repository_Patch_Call) Run(run func(_a0 context.Context, _a1 domain.GrantUpdate)) *Repository_Patch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Repository_Patch_Call) Return(_a0 error) *Repository_Patch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Repository_Patch_Call) RunAndReturn(run func(context.Context, domain.GrantUpdate) error) *Repository_Patch_Call {
	_c.Call.Return(run)
	return _c
}
