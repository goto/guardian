...
func (_e *Client_Expecter) GetResources(ctx interface{}, pc interface{}) *Client_GetResources_Call {
	return &Client_GetResources_Call{Call: _e.mock.On("GetResources", ctx, pc)}
}

func (_c *Client_GetResources_Call) Run(run func(ctx context.Context, pc *domain.ProviderConfig)) *Client_GetResources_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_GetResources_Call) RunAndReturn(run func(context.Context, *domain.ProviderConfig) ([]*domain.Resource, error)) *Client_GetResources_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *Client_Expecter) GrantAccess(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Client_GrantAccess_Call {
	return &Client_GrantAccess_Call{Call: _e.mock.On("GrantAccess", _a0, _a1, _a2)}
}
...
func (_c *Client_GrantAccess_Call) RunAndReturn(run func(context.Context, *domain.ProviderConfig, domain.Grant) error) *Client_GrantAccess_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *Client_Expecter) RevokeAccess(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Client_RevokeAccess_Call {
	return &Client_RevokeAccess_Call{Call: _e.mock.On("RevokeAccess", _a0, _a1, _a2)}
}

func (_c *Client_RevokeAccess_Call) Run(run func(_a0 context.Context, _a1 *domain.ProviderConfig, _a2 domain.Grant)) *Client_RevokeAccess_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*domain.ProviderConfig), args[2].(domain.Grant))
	})
	return _c
...
func (_c *Client_RevokeAccess_Call) RunAndReturn(run func(context.Context, *domain.ProviderConfig, domain.Grant) error) *Client_RevokeAccess_Call {
	_c.Call.Return(run)
	return _c
}
