...
func (_m *ActivityManager) GetActivities(_a0 context.Context, _a1 domain.Provider, _a2 domain.ImportActivitiesFilter) ([]*domain.Activity, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.Provider, domain.ImportActivitiesFilter) ([]*domain.Activity, error)); ok {
...
func (_c *ActivityManager_GetActivities_Call) RunAndReturn(run func(context.Context, domain.Provider, domain.ImportActivitiesFilter) ([]*domain.Activity, error)) *ActivityManager_GetActivities_Call {
	_c.Call.Return(run)
	return _c
}

type mockConstructorTestingTNewActivityManager interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewActivityManager(t mockConstructorTestingTNewActivityManager) *ActivityManager {
