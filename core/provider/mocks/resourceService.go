...
func (_m *ResourceService) Create(_a0 context.Context, _a1 *domain.Resource) error {
	ret := _m.Called(_a0, _a1)
...
//   - _a0 context.Context
//   - _a1 *domain.Resource
func (_e *ResourceService_Expecter) Create(_a0 interface{}, _a1 interface{}) *ResourceService_Create_Call {
	return &ResourceService_Create_Call{Call: _e.mock.On("Create", _a0, _a1)}
}

func (_c *ResourceService_Create_Call) Run(run func(_a0 context.Context, _a1 *domain.Resource)) *ResourceService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*domain.Resource))
	})
	return _c
...
func (_c *ResourceService_Create_Call) Return(_a0 error) *ResourceService_Create_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ResourceService_Create_Call) RunAndReturn(run func(context.Context, *domain.Resource) error) *ResourceService_Create_Call {
	_c.Call.Return(run)
	return _c
}
