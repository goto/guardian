...
func (_c *CloudLoggingClientI_Close_Call) RunAndReturn(run func() error) *CloudLoggingClientI_Close_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CloudLoggingClientI) ListLogEntries(_a0 context.Context, _a1 bigquery.ImportActivitiesFilter) ([]*bigquery.Activity, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bigquery.ImportActivitiesFilter) ([]*bigquery.Activity, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_c *CloudLoggingClientI_ListLogEntries_Call) RunAndReturn(run func(context.Context, bigquery.ImportActivitiesFilter) ([]*bigquery.Activity, error)) *CloudLoggingClientI_ListLogEntries_Call {
	_c.Call.Return(run)
	return _c
}

type mockConstructorTestingTNewCloudLoggingClientI interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCloudLoggingClientI(t mockConstructorTestingTNewCloudLoggingClientI) *CloudLoggingClientI {
